"""Add behavior-candidate lifecycle observability view.

Revision ID: 20260428_obs_beh_cand_lc
Revises: 20260428_observability_timescale
Create Date: 2026-04-28

Following behavior_migrate_postgres_schema (Student): this migration adds the
dashboard-facing behavior-candidate lifecycle projection so Metabase can query
real extraction/approval/rejection/decay aggregates directly from canonical
...
revision = "20260428_obs_beh_cand_lc"
down_revision = "20260428_observability_timescale"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.execute("DROP VIEW IF EXISTS observability_behavior_candidate_lifecycle")
