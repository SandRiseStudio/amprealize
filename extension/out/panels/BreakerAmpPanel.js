...
exports.BreakerAmpPanel = void 0;
const vscode = __importStar(require("vscode"));
class BreakerAmpPanel {
    ...
    static createOrShow(extensionUri, client, mcpClient) {
        ...
        const panel = vscode.window.createWebviewPanel(BreakerAmpPanel.viewType, 'BreakerAmp Orchestrator', column, {
            enableScripts: true,
            localResourceRoots: [
...
exports.BreakerAmpPanel = BreakerAmpPanel;
BreakerAmpPanel.viewType = 'amprealize.breakeramp';
function getNonce() {
...
//# sourceMappingURL=BreakerAmpPanel.js.map
