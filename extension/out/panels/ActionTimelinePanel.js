...
exports.ActionTimelinePanel = void 0;
const vscode = __importStar(require("vscode"));
class ActionTimelinePanel {
    static createOrShow(extensionUri, mcpClient) {
        ...
        const panel = vscode.window.createWebviewPanel(ActionTimelinePanel.viewType, 'Action Timeline', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async quickReplay(actionIds, dryRun = false) {
        try {
    ...
    getHtmlForWebview() {
        const styleUri = this._panel.webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'src', 'styles', 'ActionTimelinePanel.css'));
...
<body>
    ...
    <script nonce="${nonce}">
        ...
        function updateActionsList() {
            ...
            if (actions.length === 0) {
                container.innerHTML = '<div class="empty-state">No actions recorded yet.<br><br>Record actions using:<br><code>amprealize record-action</code></div>';
                return;
            }
...
exports.ActionTimelinePanel = ActionTimelinePanel;
ActionTimelinePanel.viewType = 'amprealize.actionTimeline';
function getNonce() {
    let text = '';
...
//# sourceMappingURL=ActionTimelinePanel.js.map
