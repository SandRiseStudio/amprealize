"""Guard lifecycle view numeric casts.

Revision ID: telemetry_lifecycle_guard
Revises: telemetry_observability_records
Create Date: 2026-04-28

Following behavior_migrate_postgres_schema (Student): keep dashboard lifecycle
...
revision: str = "telemetry_lifecycle_guard"
down_revision: Union[str, None] = "telemetry_observability_records"
...
def upgrade() -> None:
    op.execute(text(LIFECYCLE_VIEW_SQL))
