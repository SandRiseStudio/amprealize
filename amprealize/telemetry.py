"""Minimal telemetry client and event structures used across amprealize stubs.
    ...
    if dsn:
        ...
        if timeout_raw:
            try:
                ...
                raise ValueError("AMPREALIZE_TELEMETRY_PG_TIMEOUT must be an integer") from exc
