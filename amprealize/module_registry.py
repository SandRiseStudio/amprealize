...
MODULE_REGISTRY: dict[str, ModuleDefinition] = {
    "goals": ModuleDefinition(
        ...
        cli_groups=("project", "board", "item", "conversation", "sprint", "label"),
        api_routers=("projects", "boards", "work_items", "conversations", "sprints"),
        capability_flags=("projects", "boards", "work_items", "conversations"),
    ),
