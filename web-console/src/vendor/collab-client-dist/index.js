...
function useCollaboration(options) {
  ...
  const [connectionState, setConnectionState] = useState("disconnected" /* Disconnected */);
  ...
  const updateCursor = useCallback((position, selectionEnd) => {
...
function ExecutionStatusBadge({
  ...
  const normalizedState = useMemo(() => normalizeExecutionState(state ?? void 0), [state]);
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "ga-exec-status-dot", "aria-hidden": "true" }),
        /* @__PURE__ */ jsx("span", { children: stateLabel }),
        showPhase && resolvedPhaseLabel && /* @__PURE__ */ jsx("span", { className: "ga-exec-phase-pill", "aria-label": `Phase ${resolvedPhaseLabel}`, children: resolvedPhaseLabel }),
        showProgress && /* @__PURE__ */ jsx("span", { className: "ga-exec-progress", role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": progress, children: /* @__PURE__ */ jsx(
          "span",
          {
...
function ExecutionStatusCard({
  ...
  const normalizedState = useMemo(() => normalizeExecutionState(status?.state ?? void 0), [status?.state]);
  ...
  const startedLabel = useMemo(() => formatRelativeTime(status?.startedAt ?? void 0), [status?.startedAt]);
  ...
  return /* @__PURE__ */ jsxs("section", { className: `ga-exec-panel ${className ?? ""}`.trim(), "aria-live": "polite", children: [
    /* @__PURE__ */ jsxs("header", { className: "ga-exec-panel-header", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "ga-exec-panel-title", children: title }),
        subtitle && /* @__PURE__ */ jsx("div", { className: "ga-exec-panel-subtitle", children: subtitle })
      ] }),
      actions && /* @__PURE__ */ jsx("div", { className: "ga-exec-actions", children: actions })
    ] }),
    isLoading && /* @__PURE__ */ jsx("div", { className: "ga-exec-empty", "aria-label": "Loading execution status", children: "Loading execution status..." }),
    !isLoading && !hasExecution && /* @__PURE__ */ jsx("div", { className: "ga-exec-empty", "aria-label": "No execution", children: emptyLabel }),
    !isLoading && hasExecution && /* @__PURE__ */ jsxs("div", { className: "ga-exec-panel-body", children: [
      /* @__PURE__ */ jsx("div", { className: "ga-exec-status-row", children: /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx("div", { className: "ga-exec-progress", role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": progress, children: /* @__PURE__ */ jsx(
        "span",
        {
          className: `ga-exec-progress-fill ${normalizedState === "running" ? "ga-exec-progress-running" : ""}`,
          style: { transform: `scaleX(${progress / 100})` }
      ...
      status?.currentStep && /* @__PURE__ */ jsxs("div", { className: "ga-exec-current-step", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta", children: [
        /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta-item", children: [
          /* @__PURE__ */ jsx("div", { className: "ga-exec-meta-label", children: "Started" }),
          /* @__PURE__ */ jsx("div", { className: "ga-exec-meta-value", children: startedLabel })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta-item", children: [
          /* @__PURE__ */ jsx("div", { className: "ga-exec-meta-label", children: "Progress" }),
          /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta-value", children: [
            progress.toFixed(0),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta-item", children: [
          /* @__PURE__ */ jsx("div", { className: "ga-exec-meta-label", children: "Tokens" }),
          /* @__PURE__ */ jsx("div", { className: "ga-exec-meta-value", children: tokenLabel })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "ga-exec-meta-item", children: [
...
function ExecutionTimeline({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx("div", { className: `ga-exec-panel ${className ?? ""}`.trim(), "aria-label": "Loading execution timeline", children: /* @__PURE__ */ jsx("div", { className: "ga-exec-empty", children: "Loading execution timeline..." }) });
  }
  if (!steps.length) {
    return /* @__PURE__ */ jsx("div", { className: `ga-exec-panel ${className ?? ""}`.trim(), "aria-label": "Execution timeline", children: /* @__PURE__ */ jsx("div", { className: "ga-exec-empty", children: emptyLabel }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: `ga-exec-timeline ${className ?? ""}`.trim(), children: [
    /* @__PURE__ */ jsxs("div", { className: "ga-exec-filter-row", children: [
      /* @__PURE__ */ jsx(
        "select",
        {
          ...
          children: phaseOptions.map((phase) => /* @__PURE__ */ jsx("option", { value: phase, children: phase === "all" ? "All phases" : formatPhaseLabel(phase) }, phase))
        }
      ),
      /* @__PURE__ */ jsx(
        "select",
        {
          ...
          children: stepTypeOptions.map((stepType) => /* @__PURE__ */ jsx("option", { value: stepType, children: stepType === "all" ? "All step types" : formatStepLabel(stepType) }, stepType))
        }
      )
    ] }),
    filteredPhases.map((group) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "ga-exec-phase-group", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "ga-exec-phase-title", children: formatPhaseLabel(group.phase) }),
              /* @__PURE__ */ jsxs("span", { className: "ga-exec-phase-meta", children: [
                group.steps.length,
                " steps",
        ...
        !isCollapsed && /* @__PURE__ */ jsx("div", { id: phaseId, className: "ga-exec-step-list", children: group.steps.map((step) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "ga-exec-step", "data-step-type": step.stepType, children: [
            /* @__PURE__ */ jsx("span", { className: "ga-exec-step-dot", "aria-hidden": "true" }),
            /* @__PURE__ */ jsxs("div", { className: "ga-exec-step-card", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  type: "button",
                  ...
                  disabled: !hasDetail,
                  children: [
                    /* @__PURE__ */ jsxs("span", { className: "ga-exec-step-type", children: [
                      formatStepLabel(step.stepType),
                      hasDetail && /* @__PURE__ */ jsx("span", { style: { marginLeft: "4px", opacity: 0.6 }, children: isExpanded ? "\u25BC" : "\u25B6" })
                    ] }),
                    /* @__PURE__ */ jsxs("span", { className: "ga-exec-step-time", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "ga-exec-step-meta", children: [
                ...
                step.toolCalls ? /* @__PURE__ */ jsxs("span", { children: [
                  "Tool calls ",
                  step.toolCalls
                ] }) : null,
                step.modelId && /* @__PURE__ */ jsxs("span", { children: [
                  "Model: ",
                  step.modelId
                ] })
              ] }),
              !isExpanded && step.contentPreview && /* @__PURE__ */ jsx("div", { className: "ga-exec-step-preview", children: step.contentPreview }),
              isExpanded && parsedContent && /* @__PURE__ */ jsxs("div", { className: "ga-exec-step-detail", style: { marginTop: "8px", fontSize: "13px" }, children: [
                parsedContent.text && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Agent Response:" }),
                  isMarkdownContent(parsedContent.text) ? /* @__PURE__ */ jsx("div", { style: { background: "var(--vscode-editor-background, #1e1e1e)", padding: "8px", borderRadius: "4px", maxHeight: "400px", overflow: "auto", marginTop: "4px", lineHeight: 1.5 }, className: "ga-exec-markdown", children: /* @__PURE__ */ jsx(Markdown, { remarkPlugins: [remarkGfm], children: parsedContent.text }) }) : /* @__PURE__ */ jsx("pre", { style: { whiteSpace: "pre-wrap", background: "var(--vscode-editor-background, #1e1e1e)", padding: "8px", borderRadius: "4px", maxHeight: "300px", overflow: "auto", marginTop: "4px" }, children: parsedContent.text })
                ] }),
                parsedContent.toolName && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Tool:" }),
                  " ",
                  /* @__PURE__ */ jsx("code", { children: parsedContent.toolName }),
                  parsedContent.success !== void 0 && /* @__PURE__ */ jsx("span", { style: { marginLeft: "8px", color: parsedContent.success ? "#4caf50" : "#f44336" }, children: parsedContent.success ? "\u2713 Success" : "\u2717 Failed" })
                ] }),
                parsedContent.inputs && Object.keys(parsedContent.inputs).length > 0 && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Inputs:" }),
                  /* @__PURE__ */ jsx("pre", { style: { whiteSpace: "pre-wrap", background: "var(--vscode-editor-background, #1e1e1e)", padding: "8px", borderRadius: "4px", maxHeight: "200px", overflow: "auto", marginTop: "4px" }, children: JSON.stringify(parsedContent.inputs, null, 2) })
                ] }),
                parsedContent.output !== void 0 && parsedContent.output !== null && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Output:" }),
                  /* @__PURE__ */ jsx("pre", { style: { whiteSpace: "pre-wrap", background: "var(--vscode-editor-background, #1e1e1e)", padding: "8px", borderRadius: "4px", maxHeight: "200px", overflow: "auto", marginTop: "4px" }, children: String(typeof parsedContent.output === "string" ? parsedContent.output : JSON.stringify(parsedContent.output, null, 2)) })
                ] }),
                parsedContent.error && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px", color: "#f44336" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Error:" }),
                  " ",
                  parsedContent.error
                ] }),
                step.toolNames && step.toolNames.length > 0 && /* @__PURE__ */ jsxs("div", { style: { marginBottom: "8px" }, children: [
                  /* @__PURE__ */ jsx("strong", { children: "Tools used:" }),
                  " ",
                  step.toolNames.join(", ")
                ] })
              ] })
...
var ClarificationCard = memo(function ClarificationCard2({
  question,
  index,
  draft,
  onChange,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ga-clar-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "ga-clar-question-header", children: [
      /* @__PURE__ */ jsx("span", { className: "ga-clar-question-number", children: index + 1 }),
      /* @__PURE__ */ jsxs("div", { className: "ga-clar-question-text", children: [
    ...
    showDetails && details && /* @__PURE__ */ jsx("div", { className: "ga-clar-context", style: { whiteSpace: "pre-wrap" }, children: details }),
    question.context && !showDetails && /* @__PURE__ */ jsx("div", { className: "ga-clar-context", children: question.context }),
    /* @__PURE__ */ jsxs("div", { className: "ga-clar-input-wrapper", children: [
      /* @__PURE__ */ jsx(
        "textarea",
        {
          ref: textareaRef,
      ...
      /* @__PURE__ */ jsx("div", { className: "ga-clar-actions", children: /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "ga-clar-hint", children: [
...
var ClarificationPanel = memo(function ClarificationPanel2({
  questions,
  onSubmit,
  isSubmitting = false,
  className,
  ...
  const [submitted, setSubmitted] = useState(/* @__PURE__ */ new Set());
  ...
  return /* @__PURE__ */ jsxs("div", { className: panelClassName, role: "region", "aria-label": "Clarification requests", children: [
    /* @__PURE__ */ jsxs("div", { className: "ga-clar-header", children: [
      /* @__PURE__ */ jsx("span", { className: "ga-clar-icon", "aria-hidden": "true", children: "\u{1F4AC}" }),
      /* @__PURE__ */ jsx("span", { className: "ga-clar-title", children: title }),
      pendingQuestions.length > 0 && /* @__PURE__ */ jsxs("span", { className: "ga-clar-subtitle", children: [
        pendingQuestions.length,
        " ",
        pendingQuestions.length === 1 ? "question" : "questions"
      ] })
    ] }),
    pendingQuestions.length === 0 && questions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ga-clar-success", children: [
      /* @__PURE__ */ jsx("span", { className: "ga-clar-success-icon", children: "\u2713" }),
      /* @__PURE__ */ jsx("span", { children: "Responses sent! The agent will continue shortly." })
    ] }),
    pendingQuestions.length > 0 && /* @__PURE__ */ jsx("div", { className: "ga-clar-questions", children: pendingQuestions.map((question, index) => /* @__PURE__ */ jsx(
      ClarificationCard,
      {
        question,
        index,
