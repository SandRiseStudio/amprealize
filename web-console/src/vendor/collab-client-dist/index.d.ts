import { CollabClientConfig, DocumentId, Document, ConnectionState, EditOperationType, UserId, UserPresence, EditOperation, CollabApiConfig, CollabApi, ProjectSettings, UpdateProjectSettingsRequest, GitHubRepoValidationRequest, GitHubRepoValidationResponse, GitHubBranchListResponse, ExecutionState, ExecutionStatus, ExecutionStep } from './core.js';
export { ActorType, AgentReplyCompletePayload, AgentSettings, BrandingSettings, ClientEditOperation, ClientMessage, CollabApiError, CollabClient, CollabClientEvents, CollaborationRole, Conversation, ConversationListResponse, ConversationMessage, ConversationMessageEventPayload, ConversationParticipant, ConversationParticipantEventPayload, ConversationReaction, ConversationReactionEventPayload, ConversationReadReceiptPayload, ConversationReadyPayload, ConversationScope, ConversationStreamClient, ConversationStreamConfig, ConversationStreamEvents, ConversationTypingPayload, CreateDocumentRequest, CreateWorkspaceRequest, DocumentType, ErrorCode, ExecutionListItem, ExecutionListResponse, ExecutionReadyEventPayload, ExecutionSnapshotEventPayload, ExecutionStatusEventPayload, ExecutionStatusSnapshotPayload, ExecutionStepEventPayload, ExecutionStepSnapshotPayload, ExecutionStepsResponse, ExecutionStreamClient, ExecutionStreamConfig, ExecutionStreamEvents, ExecutionStreamTarget, ExecutionTraceSummary, GitHubBranchInfo, MessageListResponse, MessageType, NotificationPreference, OperationId, ParticipantRole, SearchResult, SearchResultsResponse, ServerMessage, SessionId, WorkflowSettings, Workspace, WorkspaceId, createCollabApi, createCollabClient, createConversationStreamClient, createExecutionStreamClient } from './core.js';
import React from 'react';

/**
 * React hooks for Amprealize Collaboration
 *
