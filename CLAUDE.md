...
> **TL;DR**: **ALWAYS retrieve behaviors before starting any task.** Use the role that makes the most sense. Declare your role at task start. **Use Amprealize MCP tools directly** (they work natively in VS Code Copilot Chat and Claude Desktop!).
...
**Before starting ANY task**, you MUST retrieve relevant behaviors. In VS Code Copilot Chat or Claude Desktop, **use Amprealize MCP tools directly**:
